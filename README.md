...
👉 [https://william-busari-punch-assessment-work.vercel.app/](https://william-busari-punch-assessment-work.vercel.app/)
...
├── vite.config.js         # Vite build config (if used)
└── README.md              # This file
```
...
git clone https://github.com/busari007/Punch-Assessment-Work.git

# Navigate into project folder
cd Punch-Assessment-Work
...
Then open the shown **localhost** URL in your browser to preview.

---

## 📝 Styling & Design Focus
